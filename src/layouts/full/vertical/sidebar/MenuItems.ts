...
const IconComponents: { [key: string]: React.ElementType } = {
  ...
  IconNotebook: IconNotebook, IconBooks: IconBooks, IconFileCertificate: IconFileCertificate,
  IconFileImport: IconFileImport, IconCrown: IconCrown, IconFileReport: IconFileReport, IconFileText: IconFileText,
  IconListDetails: IconListDetails, IconCarOff: IconCarOff, IconFileSpreadsheet: IconFileSpreadsheet,
  IconClipboardData: IconClipboardData, IconCurrencyTaka: IconCurrencyTaka,
  IconLayoutDashboard: IconLayoutDashboard, IconChartInfographic: IconChartInfographic, 
  IconNotification: IconNotification,IconBellRinging:IconBellRinging
};
