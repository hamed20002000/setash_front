...
const ListPersonnelWorkhouseReport = () => {
    ...
    const handleExportPdfAll = async () => {
        ...
        try {
            ...
            autoTable(doc, {
                ...
                foot: [['', '', '', 'TOPLAM MAAŞ ', calculatedTotalSalaryPdf.toLocaleString('tr-TR', { style: 'currency', currency: 'TRY', minimumFractionDigits: 0, maximumFractionDigits: 2 })]],
    ...
    const handleExportExcelAll = async () => {
        ...
        try {
            ...
            sheet.addRow(["Toplam Kayıt:", result.data.length, "Toplam Maaş :", calculatedTotalSalaryExcel.toLocaleString('tr-TR', { style: 'currency', currency: 'TRY' })]);
            sheet.addRow([]);
