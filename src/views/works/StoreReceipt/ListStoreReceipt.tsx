...
const ListStoreReceipts = () => {
    ...
    // const selectedItemIds = useMemo(() => receiptDetails.map(d => d.itemId).filter(id => id !== null), [receiptDetails]);
    ...
    const exportReceiptsToPdf = (data: StoreReceiptType[], title: string, subtitle?: string) => {
        ...
        data.forEach((receipt, index) => {
            ...
            doc.text(`Durum: ${receipt.status}`, doc.internal.pageSize.getWidth() - 15, yPos, { align: 'right' });
