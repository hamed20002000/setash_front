...
// import {
//     RentalRequestType, RequestStatusHistory, Attachment, CommonRequestType, Workhouse,
...
//     requestsList: RentalRequestType[];
//     loadingData: boolean;
//     fetchRequests: (workhouseId: string | number) => void; // ⬅️ تابع فچ با WorkhouseId
...
//     const handleClickMenu = (event: React.MouseEvent<HTMLButtonElement>, row: RentalRequestType) => {
//         setAnchorEl(event.currentTarget);
//         setSelectedRowForMenu(row);
//     };

//     const handleOpenStatusModal = (status: 1 | 2, row: RentalRequestType) => {
//         setSelectedRowForMenu(row);
//         setNewStatus(status);
...
//         try {
//             // ⬅️ API CALL برای Kiralama - جایگزین شود
//             const apiEndpoint = server.baseurl + server.initialoperations + "update-workhouse-rent-status";
...
//                 fetchRequests(props.selectedWorkhouseId); // ⬅️ رفرش کردن با WorkhouseID فعلی
...
//         // fetchRequests توسط useEffect در والد فراخوانی می‌شود، اما می‌توان آن را مستقیماً اینجا نیز صدا زد:
...
//                                 <StyledTableCell sx={{ color: "#171c23" }}><Typography variant="h6">İşyeri</Typography></StyledTableCell>
...
//                                 ))
//                             ) : (
//                                 <TableRow><StyledTableCell colSpan={7} align="center"><Typography variant="subtitle1" color="textSecondary">Seçili işyerinde kayıtlı kiralama talebi bulunamadı.</Typography></StyledTableCell></TableRow>
//                             )}
//                         </TableBody>
//                     </Table>
//                 )}
...
// RentalReceiptList.tsx (کد کامل و نهایی)
