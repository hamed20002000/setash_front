...
//             doc.setFontSize(18);
//             doc.text(`Şantiyenin Depo Detayları`, pageWidth - 15, 30, { align: 'right' });
//             doc.setFontSize(12);
//             doc.text(`Şantiyenin Depo Adı: ${store.name}`, pageWidth - 15, 40, { align: 'right' });
...
//             showAlert('Şantiyenin Depo PDF dosyası başarıyla oluşturuldu.', 'success');
//         } catch (error: any) {
...
//         showAlert('Tüm Şantiyenin Depo indiriliyor...', 'info');
...
//             doc.addImage(Logo, 'PNG', 10, 10, 40, 25);
//             doc.setFontSize(18);
//             doc.text('Tüm Şantiyenin Depo Raporu', pageWidth - 15, 30, { align: 'right' });
//             doc.setFontSize(12);
...
//                                                             title={isTooltipGloballyEnabled ? "Bu Şantiyenin Depo pasif yap" : ""}>
...
//                                                     ) : (
//                                                         <CustomTooltip placement="left"
//                                                             title={isTooltipGloballyEnabled ? "Bu Şantiyenin Depo aktif yap" : ""}>
...
// =====================================================================================
// توابع کمکی برای ساختار گزارش‌دهی که شما ارائه دادید
// =====================================================================================
