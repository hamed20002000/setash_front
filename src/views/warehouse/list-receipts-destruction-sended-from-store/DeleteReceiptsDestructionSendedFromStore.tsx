// src/views/Warehouse/DeleteReceiptsDestructionSendedFromStore.tsx
...
const DeleteReceiptsDestructionSendedFromStore = ({ openModal, receiptIdToDelete, receiptCodeToDelete, onClose, onDeleteSuccess, showAlert }: Props) => {
    ...
    const handleDeleteReceipt = async () => {
        ...
        try {
            const response = await axios.delete(
                `${server.baseurl}${server.warehouse}delete-receipt-destruction-sended-from-store-to-warehouse/${receiptIdToDelete}`,
                {
                    headers: {
...
export default DeleteReceiptsDestructionSendedFromStore;