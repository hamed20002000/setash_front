        ...
        <Dialog
            ...
            <DialogContent>
                <DialogContentText id="alert-dialog-description">
                    <span style={{ fontSize: "18px", fontWeight: "bold", color: "#FA896B", margin: "0 5px" }}>{dispatchCodeToDelete} </span> kodlu İmha Edilecek Ürünleri Sevk silerseniz, geri almanın bir yolu yoktur.
