...
const DeleteBetweenwarehouseDispatch = ({ openModal, dispatchIdToDelete, dispatchCodeToDelete, onClose, onDeleteSuccess, showAlert }: Props) => {
    ...
    const handleDeleteDispatch = async () => {
        ...
        try {
            ...
            console.error("Error deleting between warehouse dispatch:", e);

            if (e.response && e.response.status === 500) {
                showAlert('Bu depolar arası sevk belgesi şu anda başka bir yerde kullanıldığı için silinemez.', 'error');
        ...
        <Dialog
            ...
            <DialogContent>
                <DialogContentText id="alert-dialog-description">
                    {dispatchCodeToDelete} kodlu depolar arası sevk belgesini silerseniz, geri almanın bir yolu yoktur.
