...
import { IconDots, IconEye, IconEdit, IconTrash, IconSearch, IconCheck, IconX, IconFileSpreadsheet, IconFile, IconFileDownload } from '@tabler/icons-react';
...
const ManualEntryForm = () => {
    ...
    // ------------------ ✅ New Export Functions (PDF & Excel) ------------------
